...
export default hopeTheme({
  ...
  hostname: "http://sonya.ekkosonya.cn",

  iconAssets: "iconfont",

  author: {
    name: "Sonya",
    url: "http://sonya.ekkosonya.cn",
  },
  ...
  copyright: `Copyright © 2024-present <a href="http://sonya.ekkosonya.cn/" target="_blank" rel="noopener noreferrer">EkkoSonya's Blog</a>`,
  displayFooter: true,
  ...
  blog: {
    ...
    roundAvatar: true,
    medias: {
      GitHub: "https://github.com/SonyaQin",
